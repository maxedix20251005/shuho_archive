...
| `ISSUE-005` | `2026-04-08` | `Admin UI (Local/GitHub Pages)` | Admin screens stuck in loading/fallback message | `admin/works.html` and `admin/enquiries.html` show fallback; script bootstrap not completing in both local and GitHub Pages environments. | `Fixing` | Added config fallback strategy, browser-compatibility JS changes, and explicit module-import error surfacing. Continuing investigation until resolved. | `-` | `Frontend Engineer` |
